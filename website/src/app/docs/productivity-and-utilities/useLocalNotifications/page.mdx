...
<Blockquote.Caution>
	<Blockquote.Content>
		###### Most mobile browsers ignore the <strong>silent</strong> and{' '}<strong>requireInteraction</strong> options due to OS-level power management and notification center constraints.
	</Blockquote.Content>
</Blockquote.Caution>

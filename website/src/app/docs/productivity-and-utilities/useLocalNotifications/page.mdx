...
<Blockquote.Important>
	<Blockquote.Content>
		Unlike the external version, this hook manages notification state locally
		within the component. It still requires HTTPS and explicit user permission
		to show system-level alerts.
	</Blockquote.Content>
</Blockquote.Important>

<Blockquote.Caution>
	<Blockquote.Content>
		Most mobile browsers ignore the <strong>silent</strong> and{' '}
		<strong>requireInteraction</strong> options due to OS-level power management
		and notification center constraints.
	</Blockquote.Content>
</Blockquote.Caution>

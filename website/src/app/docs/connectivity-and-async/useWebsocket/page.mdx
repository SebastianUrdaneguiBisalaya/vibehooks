...
export const metadata = {
  title: 'useWebsocket - vibeHooks',
  description: 'A comprehensive React hook for managing WebSocket connections with built-in auto-reconnection logic, message history, and SSR safety.',
  openGraph: {
    title: 'useWebsocket - vibeHooks',
    description: 'A comprehensive React hook for managing WebSocket connections with built-in auto-reconnection logic, message history, and SSR safety.',
  }
...
import { useWebsocket } from "@vibehooks/react/useWebsocket";

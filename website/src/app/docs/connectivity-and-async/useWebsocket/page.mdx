...
<Blockquote.Warning>
	<Blockquote.Content>
		###### Calling <strong>send()</strong> while <strong>isConnected</strong> is{' '}<strong>false</strong> will not queue the message; the operation will fail and update the <strong>error</strong> state immediately.
	</Blockquote.Content>
</Blockquote.Warning>

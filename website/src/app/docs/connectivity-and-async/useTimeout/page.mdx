...
export const metadata = {
  ...
  description: 'A declarative React hook for managing the lifecycle of single-execution timers with manual controls and SSR safety.',
  openGraph: {
    title: 'useTimeout - vibeHooks',
    description: 'A declarative React hook for managing the lifecycle of single-execution timers with manual controls and SSR safety.',
  }
...
<Blockquote.Note>
  <Blockquote.Content>The timer will not be scheduled if the <strong>delay</strong> is <strong>null</strong>. This is useful for conditionally enabling the timeout based on specific logic.</Blockquote.Content>
</Blockquote.Note>

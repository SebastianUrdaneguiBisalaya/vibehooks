...
<Blockquote.Note>
	<Blockquote.Content>
		The timer will not be scheduled if the <strong>delay</strong> is{' '}
		<strong>null</strong>. This is useful for conditionally enabling the timeout
		based on specific logic.
	</Blockquote.Content>
</Blockquote.Note>

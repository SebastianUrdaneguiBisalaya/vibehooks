...
<Blockquote.Important>
	<Blockquote.Content>
		###### When implementing optimistic updates via <strong>mutate</strong>, you must manually handle the state reversal inside a <strong>try/catch</strong> block within the <strong>execute</strong> call.
	</Blockquote.Content>
</Blockquote.Important>

<Blockquote.Tip>
	<Blockquote.Content>
		###### Use the <strong>params</strong> configuration to automatically serialize objects into URL query strings, avoiding manual string concatenation.
	</Blockquote.Content>
</Blockquote.Tip>

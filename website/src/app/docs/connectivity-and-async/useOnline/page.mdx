...
export const metadata = {
  title: 'useOnline - vibeHooks',
  description: 'A hook that tracks and returns the browser\'s current online connectivity status.',
  openGraph: {
    title: 'useOnline - vibeHooks',
    description: 'A hook that tracks and returns the browser\'s current online connectivity status.',
  }
...
import { useOnline } from "@vibehooks/react/useOnline";

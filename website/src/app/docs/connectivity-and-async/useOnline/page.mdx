...
<Blockquote.Caution>
	<Blockquote.Content>
		###### A <strong>true</strong> value only indicates that the device is connected to a network; it does not guarantee actual internet access or server reachability.
	</Blockquote.Content>
</Blockquote.Caution>

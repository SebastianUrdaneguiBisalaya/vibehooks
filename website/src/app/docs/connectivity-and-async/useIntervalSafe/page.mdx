...
export const metadata = {
  title: 'useIntervalSafe - vibeHooks',
  description: 'A declarative and robust React hook for managing **setInterval** lifecycles with execution limits and manual controls.',
  openGraph: {
    title: 'useIntervalSafe - vibeHooks',
    description: 'A declarative and robust React hook for managing **setInterval** lifecycles with execution limits and manual controls.',
  }

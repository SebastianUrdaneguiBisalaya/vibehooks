...
<Blockquote.Important>
	<Blockquote.Content>
		###### Geolocation requires explicit user consent. The browser will automatically display a permission prompt when <strong>getCurrentPosition</strong> or{' '}<strong>watchPosition</strong> is invoked.
	</Blockquote.Content>
</Blockquote.Important>

<Blockquote.Note>
	<Blockquote.Content>
		###### Using <strong>watchPosition</strong> continuously can significantly impact battery life on mobile devices. Ensure you call <strong>clearWatch</strong>{' '} when the tracking is no longer needed.
	</Blockquote.Content>
</Blockquote.Note>

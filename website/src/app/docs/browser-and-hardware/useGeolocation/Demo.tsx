...
import { useGeolocation } from '@vibehooks/react';
...
export default function Demo() {
	...
	return (
		<Layout>
			...
			<Tag.Primary>Status: {permissionState}</Tag.Primary>

			{!isSupported ? (
				<p className='text-sm text-red-500 bg-red-50 p-3 rounded font-reddit-sans'>

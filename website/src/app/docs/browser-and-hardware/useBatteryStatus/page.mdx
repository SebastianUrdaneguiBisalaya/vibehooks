...
<Blockquote.Caution>
	<Blockquote.Content>
		This API is deprecated in several browsers (including Firefox) due to
		privacy and fingerprinting concerns. Its availability may vary across
...
<Blockquote.Important>
	<Blockquote.Content>
		Access to battery information is only allowed in{' '}
		<strong>Secure Contexts (HTTPS)</strong>.
	</Blockquote.Content>
</Blockquote.Important>

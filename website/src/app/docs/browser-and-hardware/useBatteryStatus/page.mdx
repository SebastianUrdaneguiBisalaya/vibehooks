...
export const metadata = {
  ...
  description: 'A hardware-integration hook that provides real-time access to the system\'s battery levels, charging state, and timing estimates.',
  openGraph: {
    title: 'useBatteryStatus - vibeHooks',
    description: 'A hardware-integration hook that provides real-time access to the system\'s battery levels, charging state, and timing estimates.',
  }
...
<Blockquote.Caution>
  <Blockquote.Content>This API is deprecated in several browsers (including Firefox) due to privacy and fingerprinting concerns. Its availability may vary across different environments.</Blockquote.Content>
</Blockquote.Caution>

<Blockquote.Important>
  <Blockquote.Content>Access to battery information is only allowed in <strong>Secure Contexts (HTTPS)</strong>.</Blockquote.Content>
</Blockquote.Important>

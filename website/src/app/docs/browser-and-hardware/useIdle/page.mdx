...
<Blockquote.Tip>
	<Blockquote.Content>
		###### You can customize the <strong>events</strong> array to exclude specific interactions—for example, removing <strong>scroll</strong> to ignore page movement as an "active" state.
	</Blockquote.Content>
</Blockquote.Tip>

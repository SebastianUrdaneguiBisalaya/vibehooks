...
export const metadata = {
  title: 'useScreenOrientation - vibeHooks',
  description: 'A React hook that provides real-time access to the device\'s screen orientation state and control methods via the Screen Orientation API.',
  openGraph: {
    title: 'useScreenOrientation - vibeHooks',
    description: 'A React hook that provides real-time access to the device\'s screen orientation state and control methods via the Screen Orientation API.',
  }

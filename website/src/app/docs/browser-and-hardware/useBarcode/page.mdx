...
<Blockquote.Warning>
	<Blockquote.Content>
		The Barcode Detection API is an experimental technology. Currently, it has
		limited browser support, primarily available in Chromium-based browsers.
	</Blockquote.Content>
</Blockquote.Warning>

<Blockquote.Important>
	<Blockquote.Content>
		Camera access requires a <strong>Secure Context (HTTPS)</strong> and
		explicit user permission. The <strong>start()</strong> method will trigger
...
<Blockquote.Tip>
	<Blockquote.Content>
		For optimal performance, provide a specific <strong>formats</strong> list to
		reduce the detector's processing overhead.
	</Blockquote.Content>
</Blockquote.Tip>

...
<Blockquote.Important>
	<Blockquote.Content>
		###### Camera access requires a <strong>Secure Context (HTTPS)</strong> and explicit user permission. The <strong>start()</strong> method will trigger the browser's permission prompt.
	</Blockquote.Content>
</Blockquote.Important>

<Blockquote.Tip>
	<Blockquote.Content>
		###### For optimal performance, provide a specific <strong>formats</strong> list to reduce the detector's processing overhead.
	</Blockquote.Content>
</Blockquote.Tip>

...
<Blockquote.Warning>
	<Blockquote.Content>
		Limited browser support. This experimental API is mostly available in Chrome
		and Edge. It will return <strong>supported: false</strong> in Safari and
		Firefox.
	</Blockquote.Content>
</Blockquote.Warning>
...
<Blockquote.Important>
	<Blockquote.Content>
		Bandwidth metrics (<strong>downlink</strong>, <strong>rtt</strong>) are
		heuristics based on recent activity and should be treated as rough estimates

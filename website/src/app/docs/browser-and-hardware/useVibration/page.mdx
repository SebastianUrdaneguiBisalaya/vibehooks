...
<Blockquote.Tip>
	<Blockquote.Content>
		###### You can create haptic feedback patterns by passing an array, such as{' '}<strong>[200, 100, 200]</strong>, where values represent{' '}<strong>[vibrate, pause, vibrate]</strong>.
	</Blockquote.Content>
</Blockquote.Tip>

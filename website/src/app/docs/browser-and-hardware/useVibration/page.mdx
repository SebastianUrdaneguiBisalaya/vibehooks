...
<Blockquote.Important>
	<Blockquote.Content>
		Vibrations can only be triggered after a user interaction (like a click) on
		the page. Programmatic vibrations without a prior gesture will be blocked by
		the browser.
	</Blockquote.Content>
</Blockquote.Important>
...
<Blockquote.Tip>
	<Blockquote.Content>
		You can create haptic feedback patterns by passing an array, such as{' '}
		<strong>[200, 100, 200]</strong>, where values represent{' '}
		<strong>[vibrate, pause, vibrate]</strong>.
	</Blockquote.Content>
</Blockquote.Tip>

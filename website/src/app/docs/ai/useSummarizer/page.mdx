...
<Blockquote.Caution>
	<Blockquote.Content>
		This hook relies on the experimental{' '}
		<strong>Window AI (Summarizer) API</strong>.
	</Blockquote.Content>
</Blockquote.Caution>

<Blockquote.Important>
	<Blockquote.Content>
		Always call the <strong>destroy()</strong> method when the component
		unmounts or the summarizer is no longer needed to free up browser-side AI
		model resources and memory.
	</Blockquote.Content>
</Blockquote.Important>

<Blockquote.Tip>
	<Blockquote.Content>
		Use <strong>checkAvailability()</strong> before calling create() to handle
		cases where the model needs to be downloaded before use.
	</Blockquote.Content>
</Blockquote.Tip>

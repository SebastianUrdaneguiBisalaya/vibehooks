...
<Blockquote.Note>
	<Blockquote.Content>
		This hook provides a "Click Outside" and "Escape Key" listener out of the
		box. Ensure that both the <strong>anchorRef</strong> and{' '}
		<strong>popoverRef</strong> are correctly assigned to avoid the popover
		closing immediately when clicking the trigger.
	</Blockquote.Content>
</Blockquote.Note>

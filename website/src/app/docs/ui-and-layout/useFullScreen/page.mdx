...
<Blockquote.Caution>
	<Blockquote.Content>
		###### Fullscreen support varies significantly on mobile browsers (especially iOS Safari, where only the <strong>video</strong> element typically supports native fullscreen).
	</Blockquote.Content>
</Blockquote.Caution>

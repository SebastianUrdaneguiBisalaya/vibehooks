...
<Blockquote.Important>
	<Blockquote.Content>
		###### When using <strong>remove()</strong>, you must provide the same{' '}<strong>path</strong> and <strong>domain</strong> options used when the cookie was originally set; otherwise, the browser will fail to delete it.
	</Blockquote.Content>
</Blockquote.Important>

...
export const metadata = {
  title: 'usePreviousDistinct - vibeHooks',
  description: 'A utility hook that captures the last distinct value of a variable, filtering out redundant consecutive updates.',
  openGraph: {
    title: 'usePreviousDistinct - vibeHooks',
    description: 'A utility hook that captures the last distinct value of a variable, filtering out redundant consecutive updates.',
  }

...
<Blockquote.Note>
	<Blockquote.Content>
		This hook uses <strong>Object.is</strong> for comparison. It only updates
		the "previous" reference when the current value actually changes, making it
		ideal for tracking props or IDs.
	</Blockquote.Content>
</Blockquote.Note>

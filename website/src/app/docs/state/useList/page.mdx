...
<Blockquote.Note>
	<Blockquote.Content>
		All methods (<strong>push</strong>, <strong>insert</strong>,{' '}
		<strong>remove</strong>, <strong>update</strong>) are immutable. They
		generate a new array reference to ensure React detects the change and
		triggers a re-render correctly.
	</Blockquote.Content>
</Blockquote.Note>

...
import { useList } from '@vibehooks/react';
...
export default function Demo() {
	...
	return (
		<Layout>
					...
					items?.map((item, idx) => (
						...
						>
							...
							<div className='flex flex-row items-center gap-2'>
								...
								<Button.Secondary
									onClick={() => update(idx, { ...item, completed: false })}
								>
									Done
								</Button.Secondary>
							</div>
			...
			<Layout.Caption>
				Additionally, <strong>useList</strong> returns an{' '}
				<strong>insert</strong> function that allows you to add items to the

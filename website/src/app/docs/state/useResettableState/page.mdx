...
<Blockquote.Tip>
	<Blockquote.Content>
		###### Highly useful for complex forms or filters. Instead of manually setting every field back to its default, a single call to <strong>reset()</strong>{' '}restores the state to its exact <strong>initialState</strong>.
	</Blockquote.Content>
</Blockquote.Tip>

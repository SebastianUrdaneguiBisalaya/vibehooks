...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    <div className="max-w-5xl w-full mx-auto self-center p-6 md:p-8">
      <div className="flex flex-col items-start fixed -left-60 -top-10 blur-xl z-0 ">
        <div className="h-40 rounded-full w-80 md:w-180 z-1 bg-linear-to-b blur-[8rem] from-green-600 to-sky-600"></div>
        <div className="h-40 rounded-full w-120 md:w-240 z-1 bg-linear-to-b blur-[8rem] from-pink-900 to-yellow-400"></div>
        <div className="h-40 rounded-full w-80 md:w-180 z-1 bg-linear-to-b blur-[8rem] from-yellow-600 to-sky-300"></div>
      </div>

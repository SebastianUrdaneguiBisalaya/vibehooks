...
<Blockquote.Caution>
	<Blockquote.Content>
		Frequent resizing can trigger many re-renders. If you only need to react to
		specific breakpoints, consider using <strong>useIsDesktop</strong> or a{' '}
		<strong>matchMedia</strong> based hook instead for better performance.
	</Blockquote.Content>
</Blockquote.Caution>

...
<Blockquote.Tip>
	<Blockquote.Content>
		While this hook is convenient, for simple layout changes, consider using{' '}
		<strong>CSS Media Queries</strong> first to avoid the "flash of unstyled
		content" (FOUC) during the initial hydration.
	</Blockquote.Content>
</Blockquote.Tip>
